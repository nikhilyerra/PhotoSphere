...
function LearnMore() {
    return (
        <div className="LearnMore">
            ...
            <p>Upload your precious memories on cloud in a click. PixelGram provides features for single photo upload and bulk photos upload.</p>
            ...
            <footer className="py-5 bg-black">
                <div className="container">
                    <p className="m-0 text-center text-white small">Copyright &copy; PixelGram 2021</p>
                </div>
            </footer>
